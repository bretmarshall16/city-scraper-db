...
GO
PRINT N'Altering [dbo].[AwayRecord]...';


GO
ALTER VIEW [dbo].[AwayRecord]
	AS
	...
	s.name
GO
PRINT N'Altering [dbo].[HomeRecord]...';


GO
ALTER VIEW [dbo].[HomeRecord]
	AS 
	...
	s.name
GO
PRINT N'Altering [dbo].[TotalRecord]...';


GO
ALTER VIEW [dbo].[TotalRecord]
	AS 
