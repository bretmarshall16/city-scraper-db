...
GO
PRINT N'Creating [dbo].[TotalStats]...';


GO
CREATE VIEW [dbo].[TotalStats]
	AS
	select p.Id, p.Name Player, s.Name School, Sum(pg.Goals) total_goals, Sum(pg.Assists) total_assists, (Sum(pg.Goals) *2 + Sum(pg.Assists)) total 
	from Player as p
