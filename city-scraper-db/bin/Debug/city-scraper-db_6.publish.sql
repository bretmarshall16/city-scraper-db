...
GO
PRINT N'Creating [dbo].[TotalRecord]...';


GO
CREATE VIEW [dbo].[TotalRecord]
	AS 
	select aw.name,   aw.AwayTeamId, aw.Wins + hw.Wins 'Wins', aw.Ties + hw.Ties 'Ties', aw.Losses + hw.Losses 'Loses'  from AwayRecord as aw
